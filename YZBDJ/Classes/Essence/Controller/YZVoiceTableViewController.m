...
@interface YZVoiceTableViewController ()

@end

@implementation YZVoiceTableViewController
...
- (void)tabBarClick
{
    ...
    if (scrollView.contentOffset.x/YZScreenWidth == 2) {
        YZLog(@"%@-刷新",self.class);
    }
}
