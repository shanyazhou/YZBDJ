...
@interface YZImageTableViewController ()

@end

@implementation YZImageTableViewController
...
- (void)tabBarClick
{
    ...
    if (scrollView.contentOffset.x/YZScreenWidth == 3) {
        YZLog(@"%@-刷新",self.class);
    }
}
